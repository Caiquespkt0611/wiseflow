...
export async function PUT(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  const receita = await prisma.receitaVariavel.findFirst({
  ...
  try {
    ...
    const updated = await prisma.receitaVariavel.update({
      where: { id: params.id },
      data: {
        ...data,
...
export async function DELETE(_req: NextRequest, { params }: { params: { id: string } }) {
  ...
  await prisma.receitaVariavel.delete({ where: { id: params.id } });
